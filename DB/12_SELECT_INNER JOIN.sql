...
SELECT 테이블1.속성명1, 테이블1.속성명2,...,테이블2.속성명1, 테이블2.속성명2,....
FROM 
	테이블1
...
SELECT * FROM COURSE WHERE SUBJECT_CODE IN(SELECT CODE FROM SUBJECT)
Group BY SELECT_CODE;
SELECT SUBJECT_CODE AS 과목코드, COUNT(*) AS 수강생 FROM COURSE JOIN SUBJECT ON SUBJECT-CODE WHERE TITLE ='E대학물리'
...
SELECT DISTINCT TITLE AS 강의명 FROM COURSE JOIN SUBJECT ON SUBJECT_CODE = CODE
