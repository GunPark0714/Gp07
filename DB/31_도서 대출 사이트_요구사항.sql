...
- 관리자 1명
- 도서는 제목, 작가, 분류번호, 도서번호, 대출상태
- 대출도서는 제목, 대출시작일, 대출종료일, 대출기간 
- 회원은 아이디, 비번, 이메일, 전화번호, 이름, 주소, 대출도서명, 대출기간, 연체기간, 사진을 포함해서 등록한다.
- 회원 가입시 아이디는 중복체크를 하고, 전화번호를 통해 본인인증을 한다. 
- 회원은 본인의 대출기록을 확인할 수 있다. 
- 회원은 도서제목, 작가로 도서검색을 할 수 있다.
- 회원은 도서검색시 제목, 작가, 분류번호, 도서번호, 대출상태를 조회할 수 있다.
- 도서검색 시 도서가 대출중이면 대출중이라고 출력하고 대출불가능이라고 표시한다.

* 강사님 버전
- 대출/반납은 회원만 가능
- 회원 가입은 아이디, 비번, 전화번호 생년월일을 입력하여 가입한다.
- 회원은 회원과 관리자로 구분 
...
- 예약은 대출가능한 도서나 대출중이지만 예약되지 않은 도서만 가능
