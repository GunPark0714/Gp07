...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		//str에서 7번지부터 Wo가 있는지 확인, orld에서 o가 있는지 확인 => 없음 =>-1
		/*int index = str.indexOf("wo", 6);
		...
		//replace : 특정 문자나 문자열을을 바꿀 때 사용. 첫번쨰 문자/문자열만 수정
		...
		System.out.println(str + "에서 0번지부터" + "o" + "가 오른쪽부터 있나요?" + 
		index);
		...
		//trim 시작문자(a) 전 공백, 마지막문자 후 공백을 제거, 사이에 있는 공백은 제거 못함
		String str4 = "\n\t\tabc\t\tdef\t\n";
