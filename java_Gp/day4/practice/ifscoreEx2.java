...
public class ifscoreEx2 {
	...
	public static void main(String[] args) {
		...
		if(score < 0 || score > 100){System.out.println( "wrong score!");}
		else if(score >=90){System.out.println( "A" );}
	    else if(score >=90){System.out.println( "B" );}
		else if(score >=90){System.out.println( "C" );}
		else if(score >=90){System.out.println( "D" );}
		else if(score >=90){System.out.println( "F" );}
